...
def matting_laplacian(image, trimap, constraint_factor=0.005, norm=False):
...
def make_system(L, trimap, constraint_factor=0.005):
    ...
    b = constraint_factor*is_known.astype(np.float64)
